...
if (isset($_POST['fname'])      &&
    ...
    if (empty($fname)) {
        ...
        $sql = "UPDATE registrar_office SET
                ...
                address = ?, employee_number=?, date_of_birth = ?, phone_number = ?, qualification = ?,gender=?, email = ?
                WHERE r_user_id=?";
        $stmt = $conn->prepare($sql);
        $stmt->execute([$uname, $fname, $lname, $address, $employee_number, $date_of_birth, $phone_number, $qualification, $gender, $email, $r_user_id]);
