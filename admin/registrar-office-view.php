    ...
    <?php 
     ...
     <div class="container mt-5">
         <div class="card" style="width: 22rem;">
          <img src="../Images/registrar-office-<?=$r_user['gender']?>.jpg" class="card-img-top" alt="...">
          <div class="card-body">
          ...
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">Email: <?=$r_user['email']?></li>
            <li class="list-group-item">Gender: <?=$r_user['gender']?></li>
            <li class="list-group-item">Date joined: <?=$r_user['date_joined']?></li>
          </ul>
          <div class="card-body">
